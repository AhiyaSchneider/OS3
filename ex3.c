...
char* removeItem(BoundedQueue* queue) {
 ...
 /**
  * unBoundQueue - Allocate memory for an UnBoundQueue structure and initialize it.
  *
  * @return: A pointer to the newly created UnBoundQueue structure.
  * @return: A pointer to the newly created UnBoundQueue structure.
  *          NULL if there was an error during memory allocation or mutex initialization.
  */
UnBoundQueue* unBoundQueue(){
...
/**
  * producerGenerate - Create producer threads and assign them to bounded queues.
  *
  * @param threads: A pointer to the array of pthread_t objects representing the producer threads.
  * @param threads: A pointer to the array of pthread_t objects representing the producer threads.
  * @param threadsNum: The number of producer threads to create.
  * @param configFile: A pointer to the file containing the configuration data.
  * @param configFile: A pointer to the file containing the configuration data.
  * @param boundQueuesArr: A pointer to the array of BoundedQueue pointers.
  */
void producerGenerate(pthread_t *threads, int threadsNum, FILE* configFile, BoundedQueue** boundQueuesArr){
 ...
 /**
  * boundQueueRead - Read an item from the specified bounded queue and process it.
  *
  * @param isDone: A pointer to the array of booleans indicating the status of each bounded queue.
  * @param isDone: A pointer to the array of booleans indicating the status of each bounded queue.
  * @param i: The index of the bounded queue to read from.
  * @param boundedQueue: A pointer to the BoundedQueue object to read from.
  * @param unBoundQueues: A pointer to the array of UnBoundQueue pointers.
  * @param boundedQueue: A pointer to the BoundedQueue object to read from.
  * @param unBoundQueues: A pointer to the array of UnBoundQueue pointers.
  *
  * @return: true if the bounded queue is done or empty. false otherwise.
  */
bool boundQueueRead(bool* isDone, int i, BoundedQueue* boundedQueue, UnBoundQueue** unBoundQueues) {
    ...
    char* item = removeItem(boundedQueue); 
...
void* dispatcher(void* arg){
 ...
 /**
  * dispatcherGenerate - Initialize unbound queues and create the dispatcher thread.
  *
  * @param dispatcherThread: A pointer to the pthread_t object representing the dispatcher thread.
  * @param dispatcherThread: A pointer to the pthread_t object representing the dispatcher thread.
  * @param threadsNum: The number of producer threads.
  * @param boundQueuesArr: A pointer to the array of BoundedQueue pointers.
  * @param boundQueuesArr: A pointer to the array of BoundedQueue pointers.
  * @param unBoundQueuesArr: A pointer to the array of UnBoundQueue pointers.
  */
void dispatcherGenerate(pthread_t* dispatcherThread, int threadsNum, BoundedQueue** boundQueuesArr, UnBoundQueue** unBoundQueuesArr) {
 ...
 /**
  * coEditor - Behavior of a co-editor thread.
  *
  * @param arg: A pointer to the CoEditorArguments structure containing the necessary queues.
  * @param arg: A pointer to the CoEditorArguments structure containing the necessary queues.
  *
  * @return: NULL.
  */
void* coEditor(void* arg){
 ...
 /**
  * coEditorsGenerate - Create co-editor threads to transfer items from unbound queues to the screen queue.
  *
  * @param threads: A pointer to the pthread_t array representing the co-editor threads.
  * @param threads: A pointer to the pthread_t array representing the co-editor threads.
  * @param configFile: A pointer to the FILE object containing the configuration data.
  * @param unBoundQueuesArr: A pointer to the array of UnBoundQueue pointers.
  * @param unBoundQueuesArr: A pointer to the array of UnBoundQueue pointers.
  * @param screenQueue: A pointer to the BoundedQueue object representing the screen queue.
  */
void coEditorsGenerate(pthread_t* threads, FILE* configFile, UnBoundQueue** unBoundQueuesArr, BoundedQueue* screenQueue) {
 ...
 /**
  * screenManager - Behavior of the screen manager thread.
  *
  * @param arg: A pointer to the ScreenManagerArguments structure containing the screen queue.
  * @param arg: A pointer to the ScreenManagerArguments structure containing the screen queue.
  *
  * @return: NULL.
  */
void* screenManager(void* arg) {
 ...
 /**
  * freeQueues - Free the memory allocated for the bounded queues and unbound queues.
  *
  * @param qTBQS: A pointer to the array of BoundedQueue pointers.
  * @param qTBQS: A pointer to the array of BoundedQueue pointers.
  * @param threads: The number of threads.
  * @param qTUBQS: A pointer to the array of UnBoundQueue pointers.
  * @param qTUBQS: A pointer to the array of UnBoundQueue pointers.
  * @param q: A pointer to the main BoundedQueue.
  */
void freeQueues(BoundedQueue** qTBQS, int threads, UnBoundQueue** qTUBQS, BoundedQueue* q) {
 ...
 /**
  * getSizeFromFile - Read the size value from the provided configuration file.
  *
  * @param configFile: A pointer to the configuration file.
  * @param configFile: A pointer to the configuration file.
  *
  * @return: The size value read from the file.
  * @return: The size value read from the file.
  */
